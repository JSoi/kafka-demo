package co.jsoi.demos.kafka.stream;

import co.jsoi.demos.kafka.stream.processor.BotCountStreamBuilder;
import co.jsoi.demos.kafka.stream.processor.EventCountTimeseriesBuilder;
import co.jsoi.demos.kafka.stream.processor.WebsiteCountStreamBuilder;
...
public class WikimediaStreamsApp {
    ...
    static {
        ...
        properties.put(StreamsConfig.BOOTSTRAP_SERVERS_CONFIG, "127.0.0.1:4092");
